...
<body
    x-data="codeSnap"
    class="bg-[#0e0e0e] text-gray-200 min-h-screen flex flex-col lg:flex-row overflow-x-hidden">

    <div class="lg:hidden flex items-center justify-between px-4 py-3 bg-[#161616] border-b border-[#2a2a2a] sticky top-0 z-40">
    ...
    <aside
        ...
        class="fixed lg:static inset-y-0 left-0 z-40 w-72 bg-[#161616] border-r border-[#2a2a2a] flex flex-col shrink-0 overflow-y-auto
               transition-transform duration-300 ease-in-out lg:translate-x-0">
        <div class="hidden lg:flex px-5 py-4 border-b border-[#2a2a2a] items-center gap-2">
            <div class="w-7 h-7 rounded-lg bg-gradient-to-br from-violet-500 to-pink-500 flex items-center justify-center text-xs font-bold">&lt;/&gt;</div>
            <span class="font-semibold text-white tracking-wide">CodeSnap</span>
            <span class="ml-auto text-[10px] text-gray-500 bg-[#222] px-2 py-0.5 rounded-full">v1.0</span>
        </div>

        <div class="lg:hidden flex items-center justify-between px-5 py-4 border-b border-[#2a2a2a]">
        ...
        <div class="panel-section px-5 py-4 space-y-3">
            ...
            <div class="flex items-center justify-between">
                ...
                <button @click="showWatermark = !showWatermark"
                    :class="showWatermark ? 'bg-violet-600' : 'bg-[#333]'"
                    class="w-10 h-5 rounded-full relative transition-colors duration-200 focus:outline-none">
        ...
        <!-- Bottom padding so FAB doesn't overlap last item on mobile -->
        <div class="h-6"></div>
    </aside>
    ...
    <main class="flex-1 flex flex-col min-h-screen">
        ...
        <!-- Canvas -->
        <div class="flex-1 flex items-center justify-center p-4 sm:p-8 bg-[#0e0e0e] overflow-auto pb-24">
            <div
                x-ref="exportArea"
                class="rounded-2xl"
                :class="bgClass"
                    ...
                    <div
                        ...
                        <div x-show="showWatermark"
                            ...
                            <span class="text-[10px] text-gray-600 font-mono">
                                Made with <span class="text-violet-400">CodeSnap</span>
                            </span>
                        </div>
                    </div>
        ...
        <!-- Footer hint -->
        <div class="bg-[#161616] border-t border-[#2a2a2a] px-4 lg:px-6 py-2 text-center">
            <p class="text-xs text-gray-600">Click the preview to edit • Drag the handles to resize</p>
        </div>
    </main>
    ...
    <button
        ...
        <!-- Icon: spinner while exporting, download otherwise -->
